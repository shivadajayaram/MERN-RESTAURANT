...
import logo2 from "./shakes/logo2.jpeg";
        ...
        <div className='flex items-center h-full justify-between'>
            ...
            <div className='flex items-center gap-4 md:gap-7'>
                <nav className='gap-4 md:gap-6 text-base md:text-lg hidden md:flex'>
                    <Link to={""}>Home</Link>
                    <Link to={"menu/6474762e47ea344f952ae2ff"}>Menu</Link>
                ...
                <div className='text-slate-600 cursor-pointer' onClick={handleShowMenu}>
                    <div className='text-3xl cursor-pointer w-8 h-8 rounded-full overflow-hidden drop-shadow-md'>
                        {userData.image ? <img src={userData.image}/>: <HiUserCircle />}
                       
                    </div>
                    {
                        showMenu && (
                        <div className='absolute right-2 bg-white py-2  shadow drop-shadow-md  flex flex-col text-center min-w-[120px]'>
                            {
                    ...
                    <nav className='text-base md:text-lg flex flex-col md:hidden'>
                     ...
                     <Link to={"menu/6474762e47ea344f952ae2ff"} className='px-2 py-1'>Menu</Link>
