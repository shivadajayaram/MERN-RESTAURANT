...
import emptyCartImage from '../shakes/empty-cart.gif'
...
const Cart = () => {
    ...
    const handlePayment=async()=>{
        ...
        toast("Oops!!You Have Not Login!!Please Login")
        setTimeout(()=>{
            navigate("/login")
        },1000)
       } 
  ...
  return (
    ...
    <div className='p-2 md:p-4'>
        <h2 className='text-lg md:text-2xl font-bold text-slate-800'>Your Cart Items</h2>
        {productCartItem[0] ?
        ...
        <div className='flex w-full justify-center items-center flex-col'>
          <img src={emptyCartImage} className='w-full max-w-4xl '/>
          <p className='text-slate-500 text-3xl font-bold'>What Are You Waiting For?Add Your Favourite Food To The Cart</p>
        </div>
        </>
         }
    </div>
